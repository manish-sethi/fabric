...
type PeerLedgerProvider interface {
	...
	Create(genesisBlock *common.Block) (PrivacyEnabledPeerLedger, error)
	// Open opens an already created ledger
	Open(ledgerID string) (PrivacyEnabledPeerLedger, error)
...
type PrivacyEnabledPeerLedger interface {
	...
	GetPrivateSimulationResults(txId string) (commonledger.ResultsIterator, error)
	// PutPrivateSimulationResults stores a private simulation results generated by an endorser as a
	// result of transaction simulation
	PutPrivateSimulationResults(txId, endorserId string, blockHeight uint64, privateSimulationResults []byte) error
	...
	// TODO: Uncomment the following two interfaces once the private store is implemented
