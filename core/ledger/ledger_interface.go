...
type PeerLedger interface {
	...
	GetPvtDataAndBlockByNum(blockNum uint64, filter PvtNsCollFilter) (*PvtDataAndBlock, error)
...
// PvtDataAndBlock encapsultes the block and a map that contains the tuples <seqInBlock, *TxPvtData>
type PvtDataAndBlock struct {
	Block        *common.Block
	BlockPvtData map[uint64]*TxPvtData
}

// PvtCollFilter represents the set of the collection names (as keys of the map)
