...
func (l *kvLedger) GetPvtDataAndBlockByNum(blockNum uint64, collections []string) (*ledger.PvtDataAndBlock, error) {
	return nil, fmt.Errorf("not yet implemented")
}

// GetPvtDataByNum returns only the pvt data  corresponding to the given block number
// The pvt data is filtered by the list of 'collections' supplied
func (l *kvLedger) GetPvtDataByNum(blockNum uint64, collections []string) ([]*ledger.TxPvtData, error) {
	return nil, fmt.Errorf("not yet implemented")
}
