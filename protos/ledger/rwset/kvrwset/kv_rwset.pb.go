...
// KVRWSet encapsulates two read-write set for a chaincode that operates upon a KV or
// Document data model, and the two read-write sets are
// (1) the primary read-write set for public data.
// (2) hashsed read-write set for private data (all collections).
type KVRWSet struct {
	// Primary read-write set for public data
	...
	// Hashed read-write set for private data
	HashedRW []*HashedRWSet `protobuf:"bytes,4,rep,name=hashed_r_w,json=hashedRW" json:"hashed_r_w,omitempty"`
}
...
func (m *KVRWSet) GetHashedRW() []*HashedRWSet {
	if m != nil {
		return m.HashedRW
	}
	return nil
...
// HashedRWSet encapsulates private read-write set of a collections for a chaincode
// that operates upon a KV or Document data model.
...
func (m *HashedRWSet) GetCollection() string {
	if m != nil {
		return m.Collection
	}
	return ""
...
// PrivateKVRWSet encapsulates private read-write set of all collections for a chaincode
// that operates upon a KV or Document data model.
type PrivateCollectionsKVRWSets struct {
	PrivateRWSet []*PrivateKVRWSet `protobuf:"bytes,1,rep,name=private_r_w_set,json=privateRWSet" json:"private_r_w_set,omitempty"`
}

func (m *PrivateCollectionsKVRWSets) Reset()                    { *m = PrivateCollectionsKVRWSets{} }
func (m *PrivateCollectionsKVRWSets) String() string            { return proto.CompactTextString(m) }
func (*PrivateCollectionsKVRWSets) ProtoMessage()               {}
func (*PrivateCollectionsKVRWSets) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *PrivateCollectionsKVRWSets) GetPrivateRWSet() []*PrivateKVRWSet {
	if m != nil {
...
// PrivateKVRWSet encapsulates private read-write set of a collection for a chaincode
// that operates upon a KV or Document data model.
type PrivateKVRWSet struct {
	Collection    string     `protobuf:"bytes,1,opt,name=collection" json:"collection,omitempty"`
	PrivateReads  []*KVRead  `protobuf:"bytes,2,rep,name=private_reads,json=privateReads" json:"private_reads,omitempty"`
	PrivateWrites []*KVWrite `protobuf:"bytes,3,rep,name=private_writes,json=privateWrites" json:"private_writes,omitempty"`
}

func (m *PrivateKVRWSet) Reset()                    { *m = PrivateKVRWSet{} }
func (m *PrivateKVRWSet) String() string            { return proto.CompactTextString(m) }
func (*PrivateKVRWSet) ProtoMessage()               {}
func (*PrivateKVRWSet) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }

func (m *PrivateKVRWSet) GetCollection() string {
	if m != nil {
		return m.Collection
	}
	return ""
...
func (m *PrivateKVRWSet) GetPrivateReads() []*KVRead {
	if m != nil {
		return m.PrivateReads
	}
	return nil
}

func (m *PrivateKVRWSet) GetPrivateWrites() []*KVWrite {
	if m != nil {
		return m.PrivateWrites
	}
	return nil
}
...
func (*KVReadHash) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*KVWriteHash) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func init() {
	...
	proto.RegisterType((*PrivateCollectionsKVRWSets)(nil), "kvrwset.PrivateCollectionsKVRWSets")
	proto.RegisterType((*PrivateKVRWSet)(nil), "kvrwset.PrivateKVRWSet")
...
var fileDescriptor0 = []byte{
	...
	,
}
