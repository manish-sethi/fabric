...
type HashedRWSet struct {
	...
	HashedReads  []*KVRead  `protobuf:"bytes,2,rep,name=hashed_reads,json=hashedReads" json:"hashed_reads,omitempty"`
	HashedWrites []*KVWrite `protobuf:"bytes,3,rep,name=hashed_writes,json=hashedWrites" json:"hashed_writes,omitempty"`
}
...
func (m *HashedRWSet) GetHashedReads() []*KVRead {
	if m != nil {
...
func (m *HashedRWSet) GetHashedWrites() []*KVWrite {
	if m != nil {
...
var fileDescriptor0 = []byte{
	...
	,
}
